...
export const mockMetrics = {
  ...
  rmse: null,
  auc_roc: 0.8618,
  training_time_s: 0.1059,
  history: [
    { epoch: 1, train_acc: 0.742, val_acc: 0.801 },
    { epoch: 2, train_acc: 0.768, val_acc: 0.829 },
    { epoch: 3, train_acc: 0.784, val_acc: 0.845 },
    { epoch: 4, train_acc: 0.793, val_acc: 0.856 },
    { epoch: 5, train_acc: 0.7984, val_acc: 0.8618 },
  ],
  confusion_matrix: [[8, 18], [0, 97]],
  feature_importance: {
    Credit_History: 1.2703,
    Married: 0.2644,
    Education: 0.1877,
    CoapplicantIncome: 0.1659,
    Loan_ID: 0.1114,
    Dependents: 0.1114,
    Gender: 0.0901,
    Self_Employed: 0.0748,
  },
  leaderboard: [
    { model_type: 'LogisticRegression', ranking_score: 0.9081, selection_metric: 'f1_score', training_time_s: 0.0037, metrics: { accuracy: 0.8618, precision: 0.84, recall: 0.9882, f1_score: 0.9081 } },
    { model_type: 'RandomForestClassifier', ranking_score: 0.8729, selection_metric: 'f1_score', training_time_s: 0.098, metrics: { accuracy: 0.813, precision: 0.8229, recall: 0.9294, f1_score: 0.8729 } },
    { model_type: 'DecisionTreeClassifier', ranking_score: 0.8304, selection_metric: 'f1_score', training_time_s: 0.0038, metrics: { accuracy: 0.7642, precision: 0.8256, recall: 0.8353, f1_score: 0.8304 } },
  ],
}
